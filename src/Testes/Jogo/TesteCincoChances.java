...
public class TesteCincoChances {
    ...
    public void setup() {
        ...
        MecanicaDoJogo modoDeJogo = FabricaMecanicaDeJogo.getJogo(2); // 1 Errou Acabaou - 2 Cinco Chances - 3 De Dez Acaba
        jogo = new CincoChances();
